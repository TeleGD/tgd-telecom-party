...
public abstract class AppGame extends StateBasedGame {
	...
	public static final int GAMES_BOMBERMAN_WORLD = 5;
	public static final int GAMES_CLICKER_WORLD = 6;
	public static final int GAMES_CODE_FALL_WORLD = 7;
	public static final int GAMES_MAZE_WORLD = 8;
	public static final int GAMES_PACMAN_BATTLE_WORLD = 9;
	public static final int GAMES_PATH_PAINTING_WORLD = 10;
